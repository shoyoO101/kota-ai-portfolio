...
const SESSION_KEY = "kota-ai-chat-session-id";
    ...
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-3">
      {mounted && (
        <div
          aria-hidden={!open}
          className={
            "flex h-[min(640px,calc(100vh-7.5rem))] w-[min(380px,calc(100vw-2.5rem))] flex-col overflow-hidden shadow-2xl " +
            (open
        ...
        >
          <header className="relative shrink-0 px-6 pb-4 pt-5">
            ...
            <div className="flex items-center justify-center gap-2 pr-10 pt-8">
              <span
